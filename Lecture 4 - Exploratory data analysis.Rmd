...
```{r include=FALSE}
# Install packages
# Setting the CRAN as default repo
r <- getOption("repos")
...
We are going to use the diamons dataset, that is coming from ggplot2.
...
There are diamons that have no size. This looks like an error.
